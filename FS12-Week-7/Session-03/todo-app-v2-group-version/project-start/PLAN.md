...
## You will need to know the following to do a group project:

Note: while you can attempt to just work of main, its recommended to do feature branches with a protected main branch

- Git branching and pull requests (Feel free to use Github Desktop)
...
- Basic Project Planning (how to break up and divide work)

1. Have one user create a github repo.
2. Have that user setup a main branch protection policy [requiring pull requests](https://docs.github.com/en/repositories/configuring-branches-and-merges-in-your-repository/managing-protected-branches/managing-a-branch-protection-rule#creating-a-branch-protection-rule)
3. Create feature branches for your work, implement one tiny feature and do a pull request with that feature branch
4. Update main locally and resolve merge conflicts as needed
5. Git branching is not trivial, keep that in mind.
