...
const capitalizedStrings = fruits.map(fruit => fruit.charAt(0).toUpperCase() + fruit.slice(1));
console.log(capitalizedStrings);

const capitalizedFruits = strings.map(s => s.charAt(0).toUpperCase() + s.slice(1));
