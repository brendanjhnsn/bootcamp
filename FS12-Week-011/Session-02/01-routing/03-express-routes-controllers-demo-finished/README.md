...
Express.js application demonstrating MVC architecture with separate routes and controllers
...
4. Click "Debug" to start the debugger with nodemon (auto-restart on changes)

5. Make requests using Postman and the debugger will pause at your breakpoints

## Port Conflict Fix

If port 3000 is already in use, stop other servers or run:
```bash
npx kill-port 3000
```
